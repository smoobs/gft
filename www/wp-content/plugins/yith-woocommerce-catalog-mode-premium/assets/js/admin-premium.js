...
jQuery(
	function ( $ ) {
		...
		$( '.ywctm-exclusions #doaction, .ywctm-exclusions #doaction2, .ywctm-exclusions #ywctm-filter-submit, .ywctm-exclusions #search-submit, .ywctm-exclusions .pagination-links, .ywctm-exclusions .yith-add-button' ).on(
			'click',
			function () {
