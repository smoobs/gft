	...
	function ( $ ) {
		...
		$(
			function () {
				...
				$( '.ywctm-metabox-wrapper input, .ywctm-metabox-wrapper select, .ywctm-metabox-wrapper .yit-icons-manager-wrapper, .ywctm-metabox-wrapper .ui-slider-horizontal, .wp-editor-area' ).on(
		...
		$( document ).on( 'focusout validate_field', '.yith-plugin-ui input.required', ywctm_validator.validateRequiredField );
