...
if ( ! function_exists( 'ywctm_upgrade_exclusions_premium' ) ) {
	...
	function ywctm_upgrade_exclusions_premium( $args ) {
		...
		$buttons_query = "SELECT GROUP_CONCAT(DISTINCT ids) as ids, button_text, protocol, url
				...
				GROUP BY url, button_text";
		$buttons       = $wpdb->get_results( $buttons_query, ARRAY_A ); //phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.PreparedSQL.NotPrepared, WordPress.DB.DirectDatabaseQuery.NoCaching
		...
		$labels_query = "SELECT GROUP_CONCAT(DISTINCT ids) as ids, button_text
				...
				GROUP BY button_text";
		$labels       = $wpdb->get_results( $labels_query, ARRAY_A ); //phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.PreparedSQL.NotPrepared, WordPress.DB.DirectDatabaseQuery.NoCaching
		...
		$button_exclusions = $wpdb->get_results( $nobuttons_query, ARRAY_A ); //phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.PreparedSQL.NotPrepared, WordPress.DB.DirectDatabaseQuery.NoCaching
		...
		$old_exclusions  = $wpdb->get_results( $exclusion_query, ARRAY_A ); //phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.PreparedSQL.NotPrepared, WordPress.DB.DirectDatabaseQuery.NoCaching
